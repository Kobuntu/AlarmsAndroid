...
public class AlarmsService_RegisterDevice extends WSObject implements android.os.Parcelable
{
	...
	public static AlarmsService_RegisterDevice loadFrom(Element root) throws Exception
	{
		if(root==null){
			return null;
		}
		AlarmsService_RegisterDevice result = new AlarmsService_RegisterDevice();
		result.load(root);
		return result;
	}
	...
	{
		Element e = ws.createElement("ns4:RegisterDevice");
		fillXML(ws,e);
		return e;
	}
	...
	public static final android.os.Parcelable.Creator<AlarmsService_RegisterDevice> CREATOR = new android.os.Parcelable.Creator<AlarmsService_RegisterDevice>()
	{
		public AlarmsService_RegisterDevice createFromParcel(android.os.Parcel in)
		{
			AlarmsService_RegisterDevice tmp = new AlarmsService_RegisterDevice();
			tmp.readFromParcel(in);
			return tmp;
		}
		public AlarmsService_RegisterDevice[] newArray(int size)
		{
			return new AlarmsService_RegisterDevice[size];
		}
	}
	;
