...
public class AlarmsService_UnregisterDevice extends WSObject implements android.os.Parcelable
{
	...
	public static AlarmsService_UnregisterDevice loadFrom(Element root) throws Exception
	{
		if(root==null){
			return null;
		}
		AlarmsService_UnregisterDevice result = new AlarmsService_UnregisterDevice();
		result.load(root);
		return result;
	}
	...
	{
		Element e = ws.createElement("ns4:UnregisterDevice");
		fillXML(ws,e);
		return e;
	}
	...
	public static final android.os.Parcelable.Creator<AlarmsService_UnregisterDevice> CREATOR = new android.os.Parcelable.Creator<AlarmsService_UnregisterDevice>()
	{
		public AlarmsService_UnregisterDevice createFromParcel(android.os.Parcel in)
		{
			AlarmsService_UnregisterDevice tmp = new AlarmsService_UnregisterDevice();
			tmp.readFromParcel(in);
			return tmp;
		}
		public AlarmsService_UnregisterDevice[] newArray(int size)
		{
			return new AlarmsService_UnregisterDevice[size];
		}
	}
	;
